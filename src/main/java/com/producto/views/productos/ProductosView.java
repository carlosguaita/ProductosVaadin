...
import com.producto.data.SamplePerson;
import com.producto.services.SamplePersonService;
...
@PageTitle("Productos")
@Route(value = "productos/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@Uses(Icon.class)
public class ProductosView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "productos/%s/edit";
